...
const attributes$3 = { "user": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-sso.sso-user" }, "quiz": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-quiz.quiz" }, "answer": { "type": "json" }, "isCorrect": { "type": "boolean" }, "score": { "type": "decimal", "precision": 5, "scale": 2, "default": 0 }, "teacherScore": { "type": "decimal", "precision": 5, "scale": 2, "default": 0 }, "scoringStatus": { "type": "enumeration", "enum": ["pending", "auto_graded", "manual_graded"], "default": "pending" }, "grader": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-sso.sso-user" }, "gradedAt": { "type": "datetime" }, "totalPoints": { "type": "integer", "default": 0 }, "submittedAt": { "type": "datetime" }, "duration": { "type": "integer", "default": 0 }, "course": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-course.course" }, "lesson": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-course.course-lesson" } };
const quizRecord$2 = {
  kind: kind$3,
...
const attributes$1 = { "user": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-sso.sso-user" }, "exam": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-quiz.quiz-exam" }, "answers": { "type": "json" }, "totalScore": { "type": "decimal", "precision": 5, "scale": 2, "default": 0 }, "isPassed": { "type": "boolean" }, "startedAt": { "type": "datetime" }, "submittedAt": { "type": "datetime" }, "duration": { "type": "integer", "default": 0 }, "attemptNumber": { "type": "integer", "default": 1 } };
