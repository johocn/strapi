...
import { Layout, Menu, Row, Col, Card, Statistic, Table, Tag, Space, message, Popconfirm, Select, DatePicker, Button, Empty, Tabs, Collapse, Drawer, Steps, Input, Alert, Descriptions, ConfigProvider } from "antd";
import zhCN from "antd/locale/zh_CN";
import { useNavigate, useLocation, useSearchParams, Routes, Route } from "react-router-dom";
import { DashboardOutlined, CloudSyncOutlined, BarChartOutlined, FundOutlined, SearchOutlined, CheckCircleOutlined, PlusOutlined } from "@ant-design/icons";
import { useFetchClient } from "@strapi/strapi/admin";
import { useState, useEffect, useRef } from "react";
import ReactECharts from "echarts-for-react";
import { ProTable, ModalForm, ProFormSelect, ProFormText, ProFormTextArea, ProFormDatePicker, ProFormDigit, ProFormGroup, ProFormSwitch } from "@ant-design/pro-components";
const { Sider, Content } = Layout;
const menuItems = [
  { key: "", icon: /* @__PURE__ */ jsx(DashboardOutlined, {}), label: "仪表盘" },
  { key: "collect", icon: /* @__PURE__ */ jsx(CloudSyncOutlined, {}), label: "采集监控" },
  { key: "metrics", icon: /* @__PURE__ */ jsx(BarChartOutlined, {}), label: "指标中心" },
  { key: "product", icon: /* @__PURE__ */ jsx(FundOutlined, {}), label: "产品管理" }
];
...
const StatCards = () => {
  ...
  return /* @__PURE__ */ jsxs(Row, { gutter: 16, children: [
    /* @__PURE__ */ jsx(Col, { span: 6, children: /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(Statistic, { title: "产品总数", value: data?.productCount ?? 0 }) }) }),
    /* @__PURE__ */ jsx(Col, { span: 6, children: /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(Statistic, { title: "采集成功率", value: data ? (data.collectSuccessRate * 100).toFixed(1) + "%" : "-", valueStyle: { color: (data?.collectSuccessRate || 0) >= 0.8 ? "#52c41a" : "#faad14" } }) }) }),
    /* @__PURE__ */ jsx(Col, { span: 6, children: /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(Statistic, { title: "指标覆盖率", value: data ? (data.riskMetricCoverage * 100).toFixed(1) + "%" : "-", valueStyle: { color: (data?.riskMetricCoverage || 0) >= 0.5 ? "#52c41a" : "#faad14" } }) }) }),
    /* @__PURE__ */ jsx(Col, { span: 6, children: /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(Statistic, { title: "今日异常", value: data?.todayAnomaly ?? 0, valueStyle: { color: (data?.todayAnomaly || 0) > 0 ? "#ff4d4f" : "#52c41a" } }) }) })
  ] });
};
const AttentionChart = () => {
  ...
  return /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(ReactECharts, { option, style: { height: 320 } }) });
};
const CollectPie = () => {
  const api = useApi();
  const [option, setOption] = useState({});
...
const AnomalyTable = () => {
  ...
  const columns = [
    { title: "类型", dataIndex: "type", width: 120, render: (v) => /* @__PURE__ */ jsx(Tag, { color: v === "collect_failed" ? "error" : "warning", children: v === "collect_failed" ? "采集失败" : "指标计算失败" }) },
  ...
  return /* @__PURE__ */ jsx(Card, { title: "近期异常", children: /* @__PURE__ */ jsx(
    Table,
    {
      rowKey: (r, i) => String(i),
      columns,
...
const Dashboard = () => /* @__PURE__ */ jsxs(Space, { direction: "vertical", size: 16, style: { width: "100%" }, children: [
  /* @__PURE__ */ jsx(StatCards, {}),
  /* @__PURE__ */ jsxs(Row, { gutter: 16, children: [
    /* @__PURE__ */ jsx(Col, { span: 14, children: /* @__PURE__ */ jsx(AttentionChart, {}) }),
    /* @__PURE__ */ jsx(Col, { span: 10, children: /* @__PURE__ */ jsx(CollectPie, {}) })
  ] }),
  /* @__PURE__ */ jsx(AnomalyTable, {})
] });
const PRODUCT_TYPES = {
  "bank-wealth": "银行理财",
  "stock-fund": "股票基金",
...
const TaskTab = () => {
  ...
  const columns = [
    ...
    { title: "采集方式", dataIndex: "collectMethod", width: 120, render: (_, r) => /* @__PURE__ */ jsx(Tag, { children: COLLECT_METHODS[r.collectMethod] }) },
    { title: "采集URL", dataIndex: "collectUrl", ellipsis: true, render: (_, r) => r.collectUrl || "-" },
    {
      ...
      render: (_, r) => {
        ...
        return /* @__PURE__ */ jsx(Tag, { color: s?.color, children: s?.label || r.collectStatus });
      }
    },
    ...
    { title: "失败次数", dataIndex: "failCount", width: 90 },
    {
      ...
      render: (_, r) => [
        ...
        /* @__PURE__ */ jsx(Popconfirm, { title: "触发采集？", onConfirm: async () => {
          try {
        ...
        }, children: /* @__PURE__ */ jsx("a", { children: "采集" }) }, "trigger")
      ]
    }
  ];
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Space, { style: { marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx(Statistic, { title: "成功", value: stats.success, valueStyle: { color: "#52c41a" } }),
      /* @__PURE__ */ jsx(Statistic, { title: "失败", value: stats.failed, valueStyle: { color: "#ff4d4f" } }),
      /* @__PURE__ */ jsx(Statistic, { title: "待采", value: stats.pending, valueStyle: { color: "#faad14" } })
    ] }),
    /* @__PURE__ */ jsx(
      ProTable,
      {
    ...
    /* @__PURE__ */ jsxs(
      ModalForm,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(ProFormSelect, { name: "collectMethod", label: "采集方式", options: Object.entries(COLLECT_METHODS).map(([v, l]) => ({ value: v, label: l })) }),
          /* @__PURE__ */ jsx(ProFormText, { name: "collectUrl", label: "采集URL", placeholder: "可使用{productCode}占位符" }),
          /* @__PURE__ */ jsx(ProFormTextArea, { name: "collectRules", label: "采集规则（JSON）", fieldProps: { rows: 6 } })
        ]
      }
    )
  ] });
...
const NavTab = () => {
  ...
  const [dateRange, setDateRange] = useState(void 0);
  ...
  const columns = [
    ...
    { title: "来源", dataIndex: "dataSource", width: 80, render: (_, r) => /* @__PURE__ */ jsx(Tag, { color: r.dataSource === "crawler" ? "blue" : "default", children: r.dataSource === "crawler" ? "爬虫" : "手动" }) }
  ];
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs(Space, { style: { marginBottom: 16 }, children: [
      ...
      /* @__PURE__ */ jsx(RangePicker, { onChange: (v) => setDateRange(v) }),
      /* @__PURE__ */ jsx(Button, { onClick: fetchNav, disabled: !selectedProduct, children: "查询" }),
      /* @__PURE__ */ jsx(Button, { type: "primary", onClick: () => setFormOpen(true), disabled: !selectedProduct, children: "新增净值" }),
      /* @__PURE__ */ jsx(Popconfirm, { title: "重算年化与风险指标？", onConfirm: async () => {
        try {
      ...
      }, disabled: !selectedProduct, children: /* @__PURE__ */ jsx(Button, { disabled: !selectedProduct, children: "重算" }) })
    ] }),
    navData.length > 0 && /* @__PURE__ */ jsx("div", { style: { marginBottom: 16, height: 300 }, children: /* @__PURE__ */ jsx(ReactECharts, { option: chartOption, style: { height: 300 } }) }),
    /* @__PURE__ */ jsx(
      ProTable,
      {
        rowKey: "id",
    ...
    /* @__PURE__ */ jsxs(
      ModalForm,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(ProFormDatePicker, { name: "navDate", label: "日期", rules: [{ required: true }] }),
          /* @__PURE__ */ jsx(ProFormDigit, { name: "unitNav", label: "单位净值", fieldProps: { step: 1e-4 } }),
          /* @__PURE__ */ jsx(ProFormDigit, { name: "accNav", label: "累计净值", fieldProps: { step: 1e-4 } }),
          /* @__PURE__ */ jsx(ProFormSelect, { name: "dataSource", label: "来源", options: [{ value: "manual", label: "手动录入" }, { value: "crawler", label: "爬虫采集" }], initialValue: "manual" })
        ]
      }
    )
  ] });
};
const LogTab = () => /* @__PURE__ */ jsx(Empty, { description: "操作日志功能规划中，暂无数据", style: { marginTop: 80 } });
const Collect = () => /* @__PURE__ */ jsx(
  Tabs,
  {
    defaultActiveKey: "task",
    items: [
      { key: "task", label: "采集任务", children: /* @__PURE__ */ jsx(TaskTab, {}) },
      { key: "nav", label: "净值明细", children: /* @__PURE__ */ jsx(NavTab, {}) },
      { key: "log", label: "操作日志", children: /* @__PURE__ */ jsx(LogTab, {}) }
    ]
  }
);
...
const MetricCards = ({ productId, period }) => {
  ...
  if (loading) return /* @__PURE__ */ jsx("div", { children: "加载中..." });
  const cards = [
  ...
  return /* @__PURE__ */ jsx(Row, { gutter: 16, children: cards.map((c) => /* @__PURE__ */ jsx(Col, { span: 6, children: /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(
    Statistic,
    {
      title: c.label,
      value: c.value === null ? "无数据" : c.format(c.value),
      suffix: /* @__PURE__ */ jsx(Tag, { color: c.rating.color, children: c.rating.label })
    }
  ) }) }, c.name)) });
};
const NavChart = ({ productId }) => {
  ...
  return /* @__PURE__ */ jsx(ReactECharts, { option, style: { height: 360 } });
};
const PeerRank = ({ period, currentProductId }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs(Space, { style: { marginBottom: 8 }, children: [
      /* @__PURE__ */ jsx("span", { children: "指标：" }),
      /* @__PURE__ */ jsx(
        Select,
        {
          value: metricName,
    ...
    /* @__PURE__ */ jsx(ReactECharts, { option, style: { height: 360 } })
  ] });
};
...
const Metrics = () => {
  ...
  const api = useApi();
  const [products, setProducts] = useState([]);
  const [productId, setProductId] = useState(Number(searchParams.get("productId")) || void 0);
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs(Space, { style: { marginBottom: 16 }, children: [
      ...
      /* @__PURE__ */ jsx(Button, { onClick: handleRecalculate, disabled: !productId, children: "手动重算" })
    ] }),
    productId ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(MetricCards, { productId, period }),
      /* @__PURE__ */ jsxs(Row, { gutter: 16, style: { marginTop: 16 }, children: [
        /* @__PURE__ */ jsx(Col, { span: 14, children: /* @__PURE__ */ jsx(NavChart, { productId }) }),
        /* @__PURE__ */ jsx(Col, { span: 10, children: /* @__PURE__ */ jsx(PeerRank, { period, currentProductId: productId }) })
      ] }),
      /* @__PURE__ */ jsx("div", { style: { marginTop: 16 }, children: /* @__PURE__ */ jsx(TrendChart, { productId }) })
    ] }) : /* @__PURE__ */ jsx("div", { style: { textAlign: "center", padding: 80, color: "#999" }, children: "请选择产品查看指标" })
  ] });
};
...
const ProductForm = ({ open, onClose, onSuccess, initialValues }) => {
  ...
  return /* @__PURE__ */ jsxs(
    ModalForm,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs(ProFormGroup, { children: [
          /* @__PURE__ */ jsx(ProFormText, { name: "productCode", label: "产品代码", rules: [{ required: true }], placeholder: "请输入产品代码" }),
          /* @__PURE__ */ jsx(ProFormText, { name: "productName", label: "产品名称", rules: [{ required: true }], placeholder: "请输入产品名称" })
        ] }),
        /* @__PURE__ */ jsxs(ProFormGroup, { children: [
          /* @__PURE__ */ jsx(ProFormSelect, { name: "productType", label: "产品类型", options: toOptions(PRODUCT_TYPES), rules: [{ required: true }] }),
          /* @__PURE__ */ jsx(ProFormSelect, { name: "riskLevel", label: "风险等级", options: toOptions(RISK_LEVELS) })
        ] }),
        /* @__PURE__ */ jsxs(ProFormGroup, { children: [
          /* @__PURE__ */ jsx(ProFormText, { name: "registerCode", label: "登记编码", placeholder: "请输入登记编码" }),
          /* @__PURE__ */ jsx(ProFormSelect, { name: "termType", label: "期限类型", options: toOptions(TERM_TYPES), allowClear: true })
        ] }),
        /* @__PURE__ */ jsxs(ProFormGroup, { children: [
          /* @__PURE__ */ jsx(ProFormSelect, { name: "company", label: "发行机构", request: async () => {
            const res = await api.getCompanies({ pageSize: 200 });
            return (res.records || []).map((c) => ({ value: c.id, label: c.name }));
          }, allowClear: true }),
          /* @__PURE__ */ jsx(ProFormDatePicker, { name: "issueDate", label: "发行日期" }),
          /* @__PURE__ */ jsx(ProFormDatePicker, { name: "maturityDate", label: "到期日期" })
        ] }),
        /* @__PURE__ */ jsx(
          Collapse,
          {
            items: [{
              ...
              children: /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx(ProFormSwitch, { name: "recommendEnabled", label: "启用推荐" }),
                /* @__PURE__ */ jsx(ProFormDigit, { name: "recommendWeight", label: "推荐权重", min: 0, fieldProps: { precision: 0 } }),
                /* @__PURE__ */ jsx(ProFormSelect, { name: "recommendTags", label: "推荐标签", mode: "multiple", options: RECOMMEND_TAGS }),
                /* @__PURE__ */ jsx(ProFormText, { name: "recommendReason", label: "推荐理由", placeholder: "请输入推荐理由" })
              ] })
            }]
          }
        )
...
const CollectDrawer = ({ open, onClose, onSuccess }) => {
  ...
  const [productNameChoice, setProductNameChoice] = useState("source");
  ...
  return /* @__PURE__ */ jsxs(
    Drawer,
    {
      ...
      children: [
        ...
        step === 0 && /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { style: { marginBottom: 8, fontWeight: 500 }, children: "数据源" }),
            /* @__PURE__ */ jsx(
              Select,
              {
                value: source,
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { style: { marginBottom: 8, fontWeight: 500 }, children: "产品编码或名称" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                value: query,
        ...
        step === 1 && result && /* @__PURE__ */ jsxs("div", { children: [
          result.verification.status === "verification_failed" && /* @__PURE__ */ jsx(
            Alert,
            {
              type: "warning",
              message: "中国理财网校验失败",
          ...
          /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }, children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("h4", { style: { marginBottom: 8 }, children: [
                "官网数据（",
                SOURCES.find((s) => s.value === source)?.label,
                "）"
              ] }),
              /* @__PURE__ */ jsxs(Descriptions, { column: 1, size: "small", bordered: true, children: [
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "产品名称", children: result.sourceData.productName }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "销售编码", children: result.sourceData.productCode }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "登记编码", children: result.sourceData.registerCode }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "风险等级", children: /* @__PURE__ */ jsx(Tag, { color: result.sourceData.riskLevel === "R1" ? "green" : result.sourceData.riskLevel === "R2" ? "blue" : "orange", children: result.sourceData.riskLevelRaw || RISK_LEVELS[result.sourceData.riskLevel] }) }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "期限类型", children: result.sourceData.termTypeRaw || TERM_TYPES[result.sourceData.termType] }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "发行日期", children: result.sourceData.issueDate || "-" }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "到期日期", children: result.sourceData.maturityDate || "-" }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "业绩基准", children: result.sourceData.benchmark || "-" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { style: { marginBottom: 8 }, children: "中国理财网数据" }),
              result.officialData ? /* @__PURE__ */ jsxs(Descriptions, { column: 1, size: "small", bordered: true, children: [
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "产品名称", children: result.officialData.productName }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "登记编码", children: result.officialData.registerCode }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "风险等级", children: /* @__PURE__ */ jsx(Tag, { color: result.officialData.riskLevel === "R1" ? "green" : result.officialData.riskLevel === "R2" ? "blue" : "orange", children: result.officialData.riskLevelRaw || RISK_LEVELS[result.officialData.riskLevel] }) }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "期限类型", children: result.officialData.termTypeRaw || TERM_TYPES[result.officialData.termType] }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "投资性质", children: result.officialData.productTypeRaw || PRODUCT_TYPES[result.officialData.productType] }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "产品状态", children: result.officialData.productStatus || "-" }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "运作模式", children: result.officialData.operationMode || "-" }),
                /* @__PURE__ */ jsx(Descriptions.Item, { label: "发行机构", children: result.officialData.companyName || "-" })
              ] }) : /* @__PURE__ */ jsx(Alert, { type: "info", message: "中国理财网未查到匹配数据" })
            ] })
          ] }),
          result.verification.differences?.length > 0 && /* @__PURE__ */ jsxs("div", { style: { marginTop: 16 }, children: [
            /* @__PURE__ */ jsx("h4", { style: { marginBottom: 8 }, children: "差异项" }),
            result.verification.differences.map((d, i) => /* @__PURE__ */ jsx(
              Alert,
              {
                ...
                description: /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("span", { children: [
                    "官网: ",
                    /* @__PURE__ */ jsx("b", { children: d.sourceValue })
                  ] }),
                  /* @__PURE__ */ jsxs("span", { style: { marginLeft: 16 }, children: [
                    "理财网: ",
                    /* @__PURE__ */ jsx("b", { children: d.officialValue })
                  ] })
                ] }),
          ...
          /* @__PURE__ */ jsxs("div", { style: { marginTop: 16, display: "flex", gap: 8 }, children: [
            /* @__PURE__ */ jsx(Button, { onClick: handleReset, children: "重新查询" }),
            /* @__PURE__ */ jsx(Button, { type: "primary", onClick: () => setStep(2), children: "确认并入库" })
          ] })
        ] }),
        step === 2 && result && /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
          /* @__PURE__ */ jsx(Alert, { type: "info", message: "请确认入库数据，可选择使用官网或理财网的产品名称" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { style: { marginBottom: 8, fontWeight: 500 }, children: "产品名称来源" }),
            /* @__PURE__ */ jsx(
              Select,
              {
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { style: { marginBottom: 8, fontWeight: 500 }, children: "校验备注（可修改）" }),
            /* @__PURE__ */ jsx(
              Input.TextArea,
              {
                value: remark,
          ...
          /* @__PURE__ */ jsxs(Descriptions, { title: "入库数据预览", column: 2, size: "small", bordered: true, children: [
            /* @__PURE__ */ jsx(Descriptions.Item, { label: "产品代码", children: result.sourceData.productCode }),
            /* @__PURE__ */ jsx(Descriptions.Item, { label: "产品名称", children: productNameChoice === "official" && result.officialData?.productName ? result.officialData.productName : result.sourceData.productName }),
            /* @__PURE__ */ jsx(Descriptions.Item, { label: "登记编码", children: result.sourceData.registerCode }),
            /* @__PURE__ */ jsx(Descriptions.Item, { label: "风险等级", children: RISK_LEVELS[result.sourceData.riskLevel] }),
            /* @__PURE__ */ jsx(Descriptions.Item, { label: "业绩基准", children: result.sourceData.benchmark || "-" }),
            /* @__PURE__ */ jsx(Descriptions.Item, { label: "期限类型", children: TERM_TYPES[result.sourceData.termType] || "-" })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8 }, children: [
            /* @__PURE__ */ jsx(Button, { onClick: () => setStep(1), children: "返回对比" }),
            /* @__PURE__ */ jsx(Button, { type: "primary", loading: submitting, onClick: handleConfirm, children: "确认入库" })
          ] })
        ] }),
        step === 3 && result && /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", padding: "40px 0" }, children: [
          /* @__PURE__ */ jsx(CheckCircleOutlined, { style: { fontSize: 48, color: "#52c41a" } }),
          /* @__PURE__ */ jsxs("h3", { style: { marginTop: 16 }, children: [
            result.sourceData.productName,
            " 入库成功"
          ] }),
          /* @__PURE__ */ jsxs("p", { style: { color: "#999" }, children: [
            "产品代码: ",
            result.sourceData.productCode
          ] }),
          /* @__PURE__ */ jsxs("div", { style: { marginTop: 24, display: "flex", gap: 8, justifyContent: "center" }, children: [
            /* @__PURE__ */ jsx(Button, { onClick: handleReset, children: "继续采集" }),
            /* @__PURE__ */ jsx(Button, { type: "primary", onClick: handleClose, children: "关闭" })
          ] })
        ] })
      ]
    }
...
const ProductList = () => {
  ...
  const columns = [
    ...
    { title: "类型", dataIndex: "productType", width: 100, render: (_, r) => /* @__PURE__ */ jsx(Tag, { children: PRODUCT_TYPES[r.productType] || r.productType }) },
    { title: "风险", dataIndex: "riskLevel", width: 80, render: (_, r) => /* @__PURE__ */ jsx(Tag, { color: riskColors[r.riskLevel], children: RISK_LEVELS[r.riskLevel] || r.riskLevel }) },
    { title: "发行机构", width: 120, render: (_, r) => r.company?.name || "-" },
    { title: "推荐权重", dataIndex: "recommendWeight", width: 90 },
    { title: "状态", dataIndex: "status", width: 80, render: (_, r) => /* @__PURE__ */ jsx(Tag, { color: r.status ? "green" : "default", children: r.status ? "启用" : "停用" }) },
    {
      title: "操作",
      width: 200,
      fixed: "right",
      ...
      render: (_, r) => [
        ...
        /* @__PURE__ */ jsx("a", { onClick: () => navigate(`/plugins/zhao-wealth/metrics?productId=${r.id}`), children: "指标" }, "metrics"),
        /* @__PURE__ */ jsx(Popconfirm, { title: "确定删除？", onConfirm: async () => {
          try {
        ...
        }, children: /* @__PURE__ */ jsx("a", { style: { color: "#ff4d4f" }, children: "删除" }) }, "del")
      ]
    }
  ];
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      ProTable,
      {
        ...
        toolBarRender: () => [
          /* @__PURE__ */ jsx(Button, { icon: /* @__PURE__ */ jsx(SearchOutlined, {}), onClick: () => setCollectOpen(true), children: "采集产品" }, "collect"),
          /* @__PURE__ */ jsx(Button, { type: "primary", icon: /* @__PURE__ */ jsx(PlusOutlined, {}), onClick: () => {
            setCurrent(void 0);
            setFormOpen(true);
          }, children: "新建产品" }, "new")
        ]
...
const CompanyList = () => {
  ...
  const columns = [
    ...
    { title: "类型", dataIndex: "companyType", width: 120, render: (_, r) => /* @__PURE__ */ jsx(Tag, { children: COMPANY_TYPES[r.companyType] || r.companyType }) },
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(
      ModalForm,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(ProFormText, { name: "name", label: "公司名称", rules: [{ required: true }] }),
          /* @__PURE__ */ jsx(ProFormText, { name: "shortName", label: "简称" }),
          /* @__PURE__ */ jsx(ProFormSelect, { name: "companyType", label: "类型", options: Object.entries(COMPANY_TYPES).map(([v, l]) => ({ value: v, label: l })) }),
          /* @__PURE__ */ jsx(ProFormText, { name: "website", label: "官网地址" }),
          /* @__PURE__ */ jsx(ProFormSwitch, { name: "status", label: "状态" })
        ]
      }
    )
  ] });
};
const Product = () => /* @__PURE__ */ jsx(
  Tabs,
  {
    defaultActiveKey: "product",
    items: [
      { key: "product", label: "产品列表", children: /* @__PURE__ */ jsx(ProductList, {}) },
      { key: "company", label: "理财公司", children: /* @__PURE__ */ jsx(CompanyList, {}) }
    ]
  }
);
const App = () => /* @__PURE__ */ jsx(ConfigProvider, { prefixCls: "zw", iconPrefixCls: "zw-icon", locale: zhCN, children: /* @__PURE__ */ jsx(PluginLayout, { children: /* @__PURE__ */ jsxs(Routes, { children: [
  ...
  /* @__PURE__ */ jsx(Route, { path: "collect", element: /* @__PURE__ */ jsx(Collect, {}) }),
  /* @__PURE__ */ jsx(Route, { path: "metrics", element: /* @__PURE__ */ jsx(Metrics, {}) }),
