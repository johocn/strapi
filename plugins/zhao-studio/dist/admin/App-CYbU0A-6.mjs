...
const menuConfig = [
  { key: "", icon: /* @__PURE__ */ jsx(HomeOutlined, {}), label: "仪表盘", permission: null },
  { key: "collect", icon: /* @__PURE__ */ jsx(CloudDownloadOutlined, {}), label: "采集管理", permission: "zhao-studio.collect-source.manage" },
  { key: "publish", icon: /* @__PURE__ */ jsx(SendOutlined, {}), label: "内容发布", permission: "zhao-studio.publish-record.manage" },
  ...
  { key: "sync-events", icon: /* @__PURE__ */ jsx(SyncOutlined, {}), label: "同步事件", permission: "zhao-studio.sync-event.manage" },
  { key: "ai-config", icon: /* @__PURE__ */ jsx(RobotOutlined, {}), label: "AI 配置", permission: "zhao-studio.article-draft.manage" }
];
...
const PermissionGate = ({
  ...
  if (mode === "disable") {
    return /* @__PURE__ */ jsx("div", { style: { opacity: 0.5, pointerEvents: "none" }, children });
  }
            ...
            renderItem: (source) => /* @__PURE__ */ jsx(
              List.Item,
              {
                actions: [
                  ...
                  /* @__PURE__ */ jsx(PermissionButton, { type: "primary", action: "zhao-studio.collect-task.manage", onClick: () => handleStartCollect(source.id), children: "开始采集" }, "collect"),
...
const PublishPage = () => {
  ...
  return /* @__PURE__ */ jsx(PermissionGate, { action: "zhao-studio.publish-record.manage", children: /* @__PURE__ */ jsxs(Space, { direction: "vertical", size: "large", style: { width: "100%" }, children: [
    ...
    selectedArticleIds.length > 0 && /* @__PURE__ */ jsx(PermissionGate, { action: "zhao-studio.publish.publish", mode: "disable", children: /* @__PURE__ */ jsx(Card, { title: "发布操作", children: /* @__PURE__ */ jsx(PublishPanel, { articleIds: selectedArticleIds }) }) })
  ] }) });
};
...
function SyncEventPage() {
  ...
  const columns = [
    ...
    { title: "创建时间", dataIndex: "createdAt", key: "createdAt" },
    {
      ...
      key: "action",
      render: (_, record) => /* @__PURE__ */ jsxs(Space, { children: [
        record.eventStatus === "pending" && /* @__PURE__ */ jsx(PermissionButton, { size: "small", type: "primary", icon: /* @__PURE__ */ jsx(CheckOutlined, {}), action: "zhao-studio.sync-event.resolve", onClick: () => handleResolve(record), children: "处理" }),
        /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(EyeOutlined, {}), onClick: () => handleView(record), children: "查看" })
      ] })
    }
  ];
  return /* @__PURE__ */ jsx(PermissionGate, { action: "zhao-studio.sync-event.manage", children: /* @__PURE__ */ jsxs(Card, { title: "同步事件管理", children: [
    /* @__PURE__ */ jsxs(Space, { style: { marginBottom: 16 }, children: [
      /* @__PURE__ */ jsxs(
        Select,
        {
