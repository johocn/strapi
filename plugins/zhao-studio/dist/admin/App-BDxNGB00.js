...
const API_BASE$6 = "/api/zhao-auth/v1/admin";
async function fetchMyInfo() {
  const res = await fetch(`${API_BASE$6}/me`, {
    method: "POST",
    credentials: "include",
...
const menuConfig = [
  { key: "", icon: /* @__PURE__ */ jsxRuntime.jsx(icons.HomeOutlined, {}), label: "仪表盘", permission: null },
  { key: "collect", icon: /* @__PURE__ */ jsxRuntime.jsx(icons.CloudDownloadOutlined, {}), label: "采集管理", permission: "zhao-studio.collect-source.manage" },
  { key: "publish", icon: /* @__PURE__ */ jsxRuntime.jsx(icons.SendOutlined, {}), label: "内容发布", permission: "zhao-studio.publish-record.manage" },
  ...
  { key: "sync-events", icon: /* @__PURE__ */ jsxRuntime.jsx(icons.SyncOutlined, {}), label: "同步事件", permission: "zhao-studio.sync-event.manage" },
  { key: "ai-config", icon: /* @__PURE__ */ jsxRuntime.jsx(icons.RobotOutlined, {}), label: "AI 配置", permission: "zhao-studio.article-draft.manage" }
];
const PluginLayout = ({ children }) => {
  ...
  const visibleItems = menuConfig.filter((item) => !item.permission || hasPermission(item.permission)).map(({ permission, ...rest }) => rest);
...
const PermissionGate = ({
  ...
  if (allowed) return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children });
  if (mode === "disable") {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { style: { opacity: 0.5, pointerEvents: "none" }, children });
  }
            ...
            renderItem: (source) => /* @__PURE__ */ jsxRuntime.jsx(
              antd.List.Item,
              {
                actions: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(PermissionButton, { type: "primary", action: "zhao-studio.collect-task.manage", onClick: () => handleStartCollect(source.id), children: "开始采集" }, "collect"),
...
const PublishPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PermissionGate, { action: "zhao-studio.publish-record.manage", children: /* @__PURE__ */ jsxRuntime.jsxs(antd.Space, { direction: "vertical", size: "large", style: { width: "100%" }, children: [
    ...
    selectedArticleIds.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(PermissionGate, { action: "zhao-studio.publish.publish", mode: "disable", children: /* @__PURE__ */ jsxRuntime.jsx(antd.Card, { title: "发布操作", children: /* @__PURE__ */ jsxRuntime.jsx(PublishPanel, { articleIds: selectedArticleIds }) }) })
  ] }) });
};
...
function SyncEventPage() {
  ...
  const columns = [
    ...
    { title: "创建时间", dataIndex: "createdAt", key: "createdAt" },
    {
      ...
      key: "action",
      render: (_, record) => /* @__PURE__ */ jsxRuntime.jsxs(antd.Space, { children: [
        record.eventStatus === "pending" && /* @__PURE__ */ jsxRuntime.jsx(PermissionButton, { size: "small", type: "primary", icon: /* @__PURE__ */ jsxRuntime.jsx(icons.CheckOutlined, {}), action: "zhao-studio.sync-event.resolve", onClick: () => handleResolve(record), children: "处理" }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PermissionGate, { action: "zhao-studio.sync-event.manage", children: /* @__PURE__ */ jsxRuntime.jsxs(antd.Card, { title: "同步事件管理", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(antd.Space, { style: { marginBottom: 16 }, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        antd.Select,
        {
