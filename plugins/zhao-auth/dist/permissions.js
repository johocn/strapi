...
exports.DEFAULT_ROLE_PERMISSIONS = exports.PERMISSION_TREE = exports.ROLE_LABELS = exports.MODULE_MANAGER_MAP = exports.ROLES = void 0;
exports.flattenPermissions = flattenPermissions;
exports.centerPermissions = centerPermissions;
exports.centerEditorPermissions = centerEditorPermissions;
exports.expandPermissionKeys = expandPermissionKeys;
 ...
 */
exports.MODULE_MANAGER_MAP = {
    website: exports.ROLES.WEBSITE_MANAGER,
    logistics: exports.ROLES.LOGISTICS_MANAGER,
    studio: exports.ROLES.STUDIO_MANAGER,
    points: exports.ROLES.POINT_MANAGER,
    course: exports.ROLES.COURSE_MANAGER,
    quiz: exports.ROLES.QUIZ_MANAGER,
    sso: exports.ROLES.SYSTEM_MANAGER,
    thirdParty: exports.ROLES.SYSTEM_MANAGER,
    oss: exports.ROLES.SYSTEM_MANAGER,
};
exports.ROLE_LABELS = {
    [exports.ROLES.ADMIN]: "系统管理员",
    [exports.ROLES.CHANNEL_ADMIN]: "渠道管理员",
    [exports.ROLES.PLUGIN_MANAGER]: "插件管理员",
    [exports.ROLES.INSTRUCTOR]: "讲师",
    [exports.ROLES.USER]: "普通用户",
    [exports.ROLES.WEBSITE_MANAGER]: "官网管理员",
    [exports.ROLES.WEBSITE_EDITOR]: "官网编辑",
    [exports.ROLES.LOGISTICS_MANAGER]: "物流管理员",
    [exports.ROLES.LOGISTICS_EDITOR]: "物流编辑",
    [exports.ROLES.COURSE_MANAGER]: "课程管理员",
    [exports.ROLES.COURSE_EDITOR]: "课程编辑",
    [exports.ROLES.STUDY_MANAGER]: "学习数据管理员",
    [exports.ROLES.STUDY_EDITOR]: "学习数据编辑",
    [exports.ROLES.QUIZ_MANAGER]: "题库管理员",
    [exports.ROLES.QUIZ_EDITOR]: "题库编辑",
    [exports.ROLES.POINT_MANAGER]: "积分管理员",
    [exports.ROLES.POINT_EDITOR]: "积分编辑",
    [exports.ROLES.MARKETING_MANAGER]: "营销管理员",
    [exports.ROLES.MARKETING_EDITOR]: "营销编辑",
    [exports.ROLES.SYSTEM_MANAGER]: "系统管理员(中心)",
    [exports.ROLES.SYSTEM_EDITOR]: "系统编辑",
    [exports.ROLES.TAG_MANAGER]: "标签管理员",
    [exports.ROLES.TAG_EDITOR]: "标签编辑",
    [exports.ROLES.STUDIO_MANAGER]: "工作室管理员",
    [exports.ROLES.STUDIO_EDITOR]: "工作室编辑",
    [exports.ROLES.WEALTH_MANAGER]: "理财管理员",
    [exports.ROLES.WEALTH_EDITOR]: "理财编辑",
};
...
function centerPermissions(centerKey) {
    const center = exports.PERMISSION_TREE[centerKey];
    if (!center?.children)
        return [];
...
function centerEditorPermissions(centerKey) {
    return centerPermissions(centerKey).filter((k) => !k.endsWith(".delete") && !k.endsWith(".manage"));
}
/** 获取权限 key 的所有子权限（含自身） */
function expandPermissionKeys(keys, tree = exports.PERMISSION_TREE) {
        ...
        for (const [k, item] of Object.entries(nodes)) {
            if (k === key) {
                ...
                if (item.children && item.type !== "menu") {
                    flattenPermissions(item.children).forEach((ck) => expanded.add(ck));
                }
                return true;
            }
...
/** 获取权限项的 label（用于前端展示） */
function getPermissionLabel(key, tree = exports.PERMISSION_TREE) {
...
exports.DEFAULT_ROLE_PERMISSIONS = {
    [exports.ROLES.ADMIN]: flattenPermissions(exports.PERMISSION_TREE),
    [exports.ROLES.CHANNEL_ADMIN]: [
    ...
    [exports.ROLES.PLUGIN_MANAGER]: flattenPermissions(((t) => {
        const result = {};
        for (const key of [
            "menu.course-center",
            "menu.quiz-center",
        ...
        return result;
    })(exports.PERMISSION_TREE)).concat([
        "menu.site-config",
        "site-config.update",
        "config.read",
        "config.update",
    ...
    [exports.ROLES.WEBSITE_MANAGER]: centerPermissions("menu.website-center").filter((k) => !k.endsWith("-global")).concat(["auth.admin-login"]),
    [exports.ROLES.WEBSITE_EDITOR]: centerEditorPermissions("menu.website-center").filter((k) => !k.endsWith("-global")).concat(["auth.admin-login"]),
    [exports.ROLES.LOGISTICS_MANAGER]: centerPermissions("menu.logistics-center").concat(["auth.admin-login"]),
    [exports.ROLES.LOGISTICS_EDITOR]: centerEditorPermissions("menu.logistics-center").concat(["auth.admin-login"]),
    [exports.ROLES.COURSE_MANAGER]: centerPermissions("menu.course-center").concat(["auth.admin-login"]),
    [exports.ROLES.COURSE_EDITOR]: centerEditorPermissions("menu.course-center").concat(["auth.admin-login"]),
    [exports.ROLES.STUDY_MANAGER]: centerPermissions("menu.study-center").concat(["auth.admin-login"]),
    [exports.ROLES.STUDY_EDITOR]: centerEditorPermissions("menu.study-center").concat(["auth.admin-login"]),
    [exports.ROLES.QUIZ_MANAGER]: centerPermissions("menu.quiz-center").concat(["auth.admin-login"]),
    [exports.ROLES.QUIZ_EDITOR]: centerEditorPermissions("menu.quiz-center").concat(["auth.admin-login"]),
    [exports.ROLES.POINT_MANAGER]: centerPermissions("menu.point-center").concat(["auth.admin-login"]),
    [exports.ROLES.POINT_EDITOR]: centerEditorPermissions("menu.point-center").concat(["auth.admin-login"]),
    [exports.ROLES.MARKETING_MANAGER]: centerPermissions("menu.marketing-center").concat(["auth.admin-login"]),
    [exports.ROLES.MARKETING_EDITOR]: centerEditorPermissions("menu.marketing-center").concat(["auth.admin-login"]),
    [exports.ROLES.SYSTEM_MANAGER]: centerPermissions("menu.system-center").concat(["auth.admin-login"]),
    [exports.ROLES.SYSTEM_EDITOR]: centerEditorPermissions("menu.system-center").concat(["auth.admin-login"]),
    [exports.ROLES.TAG_MANAGER]: centerPermissions("menu.tag-center").concat(["auth.admin-login"]),
    [exports.ROLES.TAG_EDITOR]: centerEditorPermissions("menu.tag-center").concat(["auth.admin-login"]),
    [exports.ROLES.STUDIO_MANAGER]: centerPermissions("menu.studio-center").concat(["auth.admin-login"]),
    [exports.ROLES.STUDIO_EDITOR]: centerEditorPermissions("menu.studio-center").concat(["auth.admin-login"]),
    [exports.ROLES.WEALTH_MANAGER]: centerPermissions("menu.wealth-center").concat(["auth.admin-login"]),
    [exports.ROLES.WEALTH_EDITOR]: centerEditorPermissions("menu.wealth-center").concat(["auth.admin-login"]),
};
