...
exports.default = ({ strapi }) => {
    ...
    const getConfigValue = (key, defaultValue) => {
        var _a;
        return (_a = pluginConfig === null || pluginConfig === void 0 ? void 0 : pluginConfig[key]) !== null && _a !== void 0 ? _a : defaultValue;
    };
    const syncService = {
        async backupFile(fileId) {
            ...
            if ((existingRecord === null || existingRecord === void 0 ? void 0 : existingRecord.status) === "success") {
                return;
            }
            ...
            try {
                ...
                const localPath = ((_a = file.url) === null || _a === void 0 ? void 0 : _a.startsWith(LOCAL_URL_PREFIX))
            ...
            for (let attempt = 0; attempt <= maxRetries; attempt++) {
                try {
                    const timeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error("Upload timeout")), uploadTimeoutMs));
                    ...
                    lastError = err;
                    logger.warn(`[zhao-oss] Upload attempt ${attempt + 1}/${maxRetries + 1} failed for file ${fileId}`, { error: lastError.message });
        ...
        async deleteRemote(recordId) {
            ...
            if (!record || !record.remoteUrl || record.status !== "success")
                return;
        ...
        async getSyncStats() {
            ...
            const pending = allRecords.filter((r) => r.status === "pending" || r.status === "syncing").length;
