...
const collectionName$k = "zhao_website_brand_infos";
const info$k = { "singularName": "brand-info", "pluralName": "brand-infos", "displayName": "企业品牌信息" };
...
const collectionName$j = "zhao_website_articles";
const info$j = { "singularName": "article", "pluralName": "articles", "displayName": "资讯文章" };
...
const collectionName$i = "zhao_website_article_categories";
const info$i = { "singularName": "article-category", "pluralName": "article-categories", "displayName": "文章分类" };
...
const collectionName$h = "zhao_website_products";
const info$h = { "singularName": "product", "pluralName": "products", "displayName": "产品/方案" };
...
const collectionName$g = "zhao_website_cases";
const info$g = { "singularName": "case", "pluralName": "cases", "displayName": "落地案例" };
...
const collectionName$f = "zhao_website_compliances";
const info$f = { "singularName": "compliance", "pluralName": "compliances", "displayName": "合规公示" };
...
const collectionName$e = "zhao_website_faqs";
const info$e = { "singularName": "faq", "pluralName": "faqs", "displayName": "常见问答" };
...
const attributes$e = { "site": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-common.site-config", "required": true, "inversedBy": "website_faqs" }, "question": { "type": "text", "required": true, "localized": true }, "answer": { "type": "text", "required": true, "localized": true }, "slug": { "type": "uid", "targetField": "question", "required": true }, "category": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-website.article-category", "inversedBy": "faqs" }, "tags": { "type": "relation", "relation": "manyToMany", "target": "plugin::zhao-tag.tag", "inversedBy": "website_faqs" }, "order": { "type": "integer", "default": 0 }, "isFeatured": { "type": "boolean", "default": false }, "viewCount": { "type": "biginteger", "default": 0 }, "mainEntity": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-website.knowledge-entity", "inversedBy": "faqMainEntities" }, "mentionedEntities": { "type": "relation", "relation": "manyToMany", "target": "plugin::zhao-website.knowledge-entity", "inversedBy": "faqMentions" }, "status": { "type": "enumeration", "enum": ["draft", "published", "archived"], "default": "draft" }, "publishedAt": { "type": "datetime" }, "deletedAt": { "type": "datetime", "default": null } };
const faq$2 = {
  kind: kind$e,
...
const collectionName$d = "zhao_website_tutorials";
const info$d = { "singularName": "tutorial", "pluralName": "tutorials", "displayName": "教程/操作指南" };
...
const collectionName$c = "zhao_website_downloads";
const info$c = { "singularName": "download", "pluralName": "downloads", "displayName": "下载文件管理" };
...
const collectionName$b = "zhao_website_leads";
const info$b = { "singularName": "lead", "pluralName": "leads", "displayName": "线索/留资" };
...
const collectionName$a = "zhao_website_visit_logs";
const info$a = { "singularName": "visit-log", "pluralName": "visit-logs", "displayName": "访问日志" };
...
const collectionName$9 = "zhao_website_interactions";
const info$9 = { "singularName": "interaction", "pluralName": "interactions", "displayName": "内容互动记录" };
...
const collectionName$8 = "zhao_website_search_logs";
const info$8 = { "singularName": "search-log", "pluralName": "search-logs", "displayName": "搜索日志" };
...
const collectionName$7 = "zhao_website_knowledge_entities";
const info$7 = { "singularName": "knowledge-entity", "pluralName": "knowledge-entities", "displayName": "知识图谱实体" };
...
const collectionName$6 = "zhao_website_knowledge_relations";
const info$6 = { "singularName": "knowledge-relation", "pluralName": "knowledge-relations", "displayName": "知识图谱关系" };
...
const attributes$6 = { "site": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-common.site-config", "required": true, "inversedBy": "website_knowledge_relations" }, "subjectEntity": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-website.knowledge-entity", "required": true, "inversedBy": "subjectRelations" }, "predicate": { "type": "string", "maxLength": 100, "required": true }, "objectEntity": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-website.knowledge-entity", "inversedBy": "objectRelations" }, "objectValue": { "type": "json" }, "objectText": { "type": "text" }, "sourceUrl": { "type": "string", "maxLength": 500 }, "sourceType": { "type": "enumeration", "enum": ["official", "derived", "manual", "inferred"], "default": "manual" }, "confidence": { "type": "decimal", "default": 1 }, "lastVerifiedAt": { "type": "datetime" }, "verificationStatus": { "type": "enumeration", "enum": ["verified", "pending", "outdated", "conflict"], "default": "verified" }, "status": { "type": "boolean", "default": true }, "deletedAt": { "type": "datetime", "default": null } };
...
const collectionName$5 = "zhao_website_ai_summaries";
const info$5 = { "singularName": "ai-content-summary", "pluralName": "ai-content-summaries", "displayName": "机器可读摘要" };
...
const collectionName$4 = "zhao_website_first_truths";
const info$4 = { "singularName": "first-truth-policy", "pluralName": "first-truth-policies", "displayName": "第一真值策略声明" };
...
const collectionName$3 = "zhao_website_brand_voices";
const info$3 = { "singularName": "brand-voice", "pluralName": "brand-voices", "displayName": "品牌话术" };
...
const collectionName$2 = "zhao_website_redirect_rules";
const info$2 = { "singularName": "redirect-rule", "pluralName": "redirect-rules", "displayName": "重定向规则" };
...
const attributes$2 = { "site": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-common.site-config", "inversedBy": "website_redirect_rules" }, "fromPath": { "type": "string", "required": true, "maxLength": 500 }, "toUrl": { "type": "string", "required": true, "maxLength": 500 }, "statusCode": { "type": "integer", "default": 301 }, "isActive": { "type": "boolean", "default": true }, "deletedAt": { "type": "datetime", "default": null } };
const redirectRule = {
  kind: kind$2,
...
const collectionName$1 = "zhao_website_invite_traces";
const info$1 = { "singularName": "invite-trace", "pluralName": "invite-traces", "displayName": "邀请码流转埋点" };
...
const attributes$1 = { "event": { "type": "enumeration", "enum": ["share_sent", "landing", "login_start", "login_callback", "redirect_back", "use_invite"], "required": true }, "inviteCode": { "type": "string", "maxLength": 100 }, "storedCode": { "type": "string", "maxLength": 100 }, "channelInviteCode": { "type": "string", "maxLength": 100 }, "inviterId": { "type": "string", "maxLength": 50 }, "targetType": { "type": "string", "maxLength": 30 }, "targetId": { "type": "string" }, "pagePath": { "type": "string", "maxLength": 200 }, "loggedIn": { "type": "boolean", "default": false }, "success": { "type": "boolean", "default": true }, "detail": { "type": "text" }, "sessionId": { "type": "string", "maxLength": 64 }, "visitorId": { "type": "string", "maxLength": 100 }, "ipAddress": { "type": "string", "maxLength": 50 }, "userAgent": { "type": "string", "maxLength": 500 }, "userId": { "type": "relation", "relation": "manyToOne", "target": "plugin::users-permissions.user" } };
const inviteTrace$2 = {
  kind: kind$1,
...
const collectionName = "zhao_website_geo_articles";
const info = { "singularName": "geo-article", "pluralName": "geo-articles", "displayName": "GEO 文章" };
const options = { "draftAndPublish": false };
const pluginOptions = { "i18n": { "localized": true }, "content-manager": { "visible": true }, "content-type-builder": { "visible": false } };
const attributes = { "site": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-common.site-config", "required": true, "inversedBy": "website_geo_articles" }, "title": { "type": "string", "maxLength": 200, "required": true, "localized": true }, "slug": { "type": "uid", "targetField": "title", "required": true, "localized": true }, "content": { "type": "text", "required": true, "localized": true, "description": "正文（HTML：文字/表格/图片/锚链接/引用标注）" }, "type": { "type": "enumeration", "enum": ["geo-article", "geo-faq", "local-report"], "default": "geo-article", "required": true }, "faqQuestion": { "type": "string", "maxLength": 200, "localized": true, "description": "type=geo-faq 时的问答标题" }, "publishedAt": { "type": "datetime" }, "articleNo": { "type": "string", "maxLength": 32, "unique": true, "description": "唯一数字标签，前端展示" }, "authorName": { "type": "string", "maxLength": 50 }, "authorBio": { "type": "text", "description": "作者从业背景简介（E-E-AT 背书）" }, "status": { "type": "enumeration", "enum": ["draft", "review", "published", "archived"], "default": "draft" }, "category": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-website.article-category", "inversedBy": "geoArticles" }, "tags": { "type": "relation", "relation": "manyToMany", "target": "plugin::zhao-tag.tag", "inversedBy": "website_geo_articles" }, "sourceName": { "type": "string", "maxLength": 100, "description": "权威来源名称" }, "sourceUrl": { "type": "string", "maxLength": 500, "description": "来源 URL（公开信源链接）" }, "sourcePublishedAt": { "type": "datetime", "description": "来源发布时间" }, "serviceScope": { "type": "text", "description": "本地服务范围：服务区县/自提仓库/线下咨询地址/履约时效/配送范围" }, "businessData": { "type": "json", "default": [], "description": "业务数据：[{period, content, caliber}] 统计起止时间/内容/口径" }, "caseContent": { "type": "text", "description": "案例内容（仅客观事实描述，禁止收益承诺）" }, "internalLinks": { "type": "json", "default": [], "description": "内部锚文本：[{text, url}] 配置 1-2 处" }, "metaTitle": { "type": "string", "maxLength": 60, "localized": true }, "metaDescription": { "type": "string", "maxLength": 160, "localized": true, "description": "建议包含吉林本地场景词" }, "canonicalUrl": { "type": "string", "maxLength": 500, "localized": true }, "jsonLdType": { "type": "enumeration", "enum": ["Article", "FAQPage", "LocalBusiness"], "default": "Article" }, "coverImage": { "type": "media" }, "isFinance": { "type": "boolean", "default": false, "description": "金融内容开关；开启后前端强制置顶不可折叠风险提示" }, "riskDisclaimer": { "type": "text", "localized": true, "description": "免责附加文本（默认模板可微调）" }, "ctaType": { "type": "enumeration", "enum": ["none", "download-list", "consult-appointment"], "default": "none", "description": "文末 CTA：本地选购清单下载 / 本地一对一咨询预约 / 不展示" }, "leadFormEnabled": { "type": "boolean", "default": false, "description": "留资表单开关" }, "vendureProductListId": { "type": "string", "maxLength": 50, "description": "关联 Vendure 商品列表 ID，正文内链使用" }, "readPoints": { "type": "integer", "default": 0, "description": "用户阅读/下载提交后发放积分数量" }, "miniProgramPath": { "type": "string", "maxLength": 200, "description": "WebView 场景跳转小程序原生商品页地址" }, "reviewerName": { "type": "string", "maxLength": 50, "description": "验收人" }, "reviewedAt": { "type": "datetime", "description": "验收日期" }, "reviewChecks": { "type": "json", "default": {}, "description": "验收勾选：{eaat, tech, compliance, business} 四类自查" }, "reviewNote": { "type": "text", "description": "上线备注" }, "summaryPoints": { "type": "text", "localized": true, "description": "知识点总结" }, "localTips": { "type": "text", "localized": true, "description": "本地注意事项" }, "infoBoundary": { "type": "text", "localized": true, "description": "信息边界说明（统计范围/适用场景/局限性）" }, "allowIndex": { "type": "boolean", "default": true }, "noFollow": { "type": "boolean", "default": false }, "deletedAt": { "type": "datetime", "default": null } };
const geoArticle$2 = {
  kind,
  collectionName,
  info,
...
const contentTypes = {
  ...
  "geo-article": { schema: geoArticle$2 }
};
const article$1 = {
  async list(ctx) {
    const siteId = ctx.state.siteId;
...
const article = ({ strapi: strapi2 }) => ({
  async find(siteId, query = {}) {
    ...
    const where = await filterService.buildWhere(siteId, UID$h, extra, locale);
  ...
  async findOne(siteId, slug, locale) {
    const filterService = strapi2.plugin("zhao-website").service("content-filter");
    const where = await filterService.buildWhere(siteId, UID$h, { slug }, locale);
  ...
  async findFeatured(siteId, limit = 5, locale) {
    const filterService = strapi2.plugin("zhao-website").service("content-filter");
    const where = await filterService.buildWhere(siteId, UID$h, { isFeatured: true }, locale);
    return strapi2.db.query(UID$h).findMany({
      where,
      limit,
      orderBy: { publishedAt: "DESC" },
...
const product = ({ strapi: strapi2 }) => ({
  ...
  async create(siteId, data) {
    const slug = data.slug || await generateUniqueSlug(strapi2, UID$e, siteId, data.name || "untitled");
    const validation = await firstTruthValidate(siteId, data);
    if (validation.hasError) {
      const e = new Error("内容与第一真值冲突（error 级）");
      e.status = 409;
...
const UID$d = "plugin::zhao-website.case";
...
const UID$c = "plugin::zhao-website.compliance";
const compliance = ({ strapi: strapi2 }) => ({
  ...
  async update(siteId, documentId, data) {
    ...
    let updateData = { ...data };
    if (data.slug && data.slug !== existing.slug) {
      updateData.slug = await generateUniqueSlug(strapi2, UID$c, siteId, data.slug, documentId);
    }
    if (data.status && isValidStatus(data.status)) {
      updateData = applyStatusChange(updateData, data.status);
    }
  ...
  async incrementViewCount(siteId, documentId) {
    const existing = await this.findOneAdmin(siteId, documentId);
    if (!existing) return;
    await strapi2.db.query(UID$c).update({
      where: { id: existing.id },
      data: { viewCount: (existing.viewCount || 0) + 1 }
    });
  }
});
const UID$b = "plugin::zhao-website.faq";
const faq = ({ strapi: strapi2 }) => ({
  ...
  async create(siteId, data) {
    const slug = data.slug || await generateUniqueSlug(strapi2, UID$b, siteId, data.question || "untitled");
    const validation = await firstTruthValidate(siteId, data);
    if (validation.hasError) {
      const e = new Error("内容与第一真值冲突（error 级）");
      e.status = 409;
...
const UID$a = "plugin::zhao-website.tutorial";
...
const UID$9 = "plugin::zhao-website.download";
const download = ({ strapi: strapi2 }) => ({
  ...
  async create(siteId, data) {
    const slug = data.slug || await generateUniqueSlug(strapi2, UID$9, siteId, data.name || "untitled");
    const validation = await firstTruthValidate(siteId, data);
    if (validation.hasError) {
      const e = new Error("内容与第一真值冲突（error 级）");
      e.status = 409;
...
const UID$8 = "plugin::zhao-website.lead";
const lead = ({ strapi: strapi2 }) => ({
  async createPublic(siteId, data, ctx) {
    ...
    return strapi2.db.query(UID$8).create({ data: enriched });
  },
  ...
  async stats(siteId) {
    const all = await strapi2.db.query(UID$8).findMany({
      where: { site: siteId, deletedAt: null }
    });
...
const UID$7 = "plugin::zhao-website.visit-log";
...
const visitLog = ({ strapi: strapi2 }) => ({
  ...
  async purgeOlderThan(days) {
    ...
    const deleted = await strapi2.db.query(UID$7).deleteMany({
...
const gate = ({ strapi: strapi2 }) => ({
  /** 消息模板版本点击量（utmSource=msg 按 utmCampaign=code 分组统计） */
  async countMsgClicks(campaigns) {
    const out = {};
    const codes = [...new Set((campaigns || []).filter(Boolean))];
    for (const code of codes) {
      out[code] = await strapi2.db.query(VISIT_LOG_UID).count({ where: { utmSource: "msg", utmCampaign: code } }).catch(() => 0);
    }
    return out;
  },
  /** 近 since 内该用户的活跃访问数 */
  async countActive(userId, since) {
    if (!Number.isInteger(userId) || userId <= 0) return 0;
    return strapi2.db.query(VISIT_LOG_UID).count({ where: { userId, createdAt: { $gte: since } } }).catch(() => 0);
  },
  /** 文章浏览记录（阅读深度用） */
  async listArticleReads(userId, opts = {}) {
    if (!Number.isInteger(userId) || userId <= 0) return [];
    const where = { userId, type: "article_view" };
    if (opts.since) where.createdAt = { $gte: opts.since };
    return strapi2.db.query(VISIT_LOG_UID).findMany({ where, select: ["id", "dwellTime", "scrollDepth"], limit: opts.limit || 200 }).catch(() => []);
  },
  /** 近 since 内浏览过的文章分类名（visit-log targetId → article.category.name，去重） */
  async collectArticleCategories(userId, opts = {}) {
    if (!Number.isInteger(userId) || userId <= 0) return [];
    const where = { userId, type: "article_view" };
    if (opts.since) where.createdAt = { $gte: opts.since };
    const reads = await strapi2.db.query(VISIT_LOG_UID).findMany({ where, select: ["targetId"], limit: opts.limit || 300 }).catch(() => []);
    const docIds = [...new Set(reads.map((r) => r.targetId).filter(Boolean))].slice(0, 200);
    if (!docIds.length) return [];
    const articles = await strapi2.db.query(ARTICLE_UID).findMany({
  ...
  async recommendArticles(interests, limit = 5) {
    let rows = [];
    if (interests?.length) {
      const cats = await strapi2.db.query(ARTICLE_CAT_UID).findMany({ where: { name: { $in: interests } }, select: ["id"] }).catch(() => []);
      const catIds = cats.map((c) => c.id);
      if (catIds.length) {
        rows = await strapi2.db.query(ARTICLE_UID).findMany({
...
const UID$6 = "plugin::zhao-website.interaction";
const interaction = ({ strapi: strapi2 }) => ({
  async toggle(siteId, data) {
    ...
    await strapi2.db.query(UID$6).create({
      data: {
        site: siteId,
        type: data.type,
        targetType: data.targetType,
...
const UID$5 = "plugin::zhao-website.search-log";
...
const knowledgeGraph = ({ strapi: strapi2 }) => ({
  ...
  async syncFromContent(targetType, content) {
    const { knowledgeGraphSync } = await Promise.resolve().then(() => require("./kg-sync-cUtn6XoH.js"));
...
const UID$4 = "plugin::zhao-website.ai-content-summary";
const aiContentSummary = ({ strapi: strapi2 }) => ({
  async findByTarget(siteId, targetType, targetId, summaryType) {
    ...
    return strapi2.db.query(UID$4).findMany({ where: filters });
  },
  ...
  async create(siteId, data) {
    ...
    return strapi2.db.query(UID$4).create({
...
const firstTruth = ({ strapi: strapi2 }) => ({
  ...
  async detectConflicts(siteId) {
    const truths = await strapi2.db.query(UID$3).findMany({
      where: { $or: [{ site: siteId, deletedAt: null, status: true }, { site: null, deletedAt: null, status: true }] }
    });
    const byKey = {};
...
const schemaBuilder = ({ strapi: strapi2 }) => ({
  ...
  buildArticle(article2, brandInfo2) {
    ...
    if (article2.brandVoiceRef?.content) {
      schema.brand = {
        "@type": "Brand",
        name: article2.brandVoiceRef.name,
        description: article2.brandVoiceRef.content
      };
    }
    return schema;
  },
...
const UID$2 = "plugin::zhao-website.brand-voice";
const brandVoice = ({ strapi: strapi2 }) => ({
  ...
  async getRefContent(siteId, category) {
    const voices = await strapi2.db.query(UID$2).findMany({
      where: {
        $or: [
          { site: siteId, category, status: true, deletedAt: null },
          { site: null, category, status: true, deletedAt: null }
...
const UID$1 = "plugin::zhao-website.redirect-rule";
const redirect = ({ strapi: strapi2 }) => ({
  async match(siteId, requestPath) {
    const rule = await strapi2.db.query(UID$1).findOne({
      where: {
        $or: [
    ...
    const wildcardRules = await strapi2.db.query(UID$1).findMany({
      where: {
        $or: [
...
const inviteTrace = ({ strapi: strapi2 }) => ({
  /**
