...
const collectionName$6 = "zhao_website_ai_summaries";
const info$6 = { "singularName": "ai-content-summary", "pluralName": "ai-content-summaries", "displayName": "机器可读摘要" };
...
const collectionName$5 = "zhao_website_first_truths";
...
const collectionName$4 = "zhao_website_brand_voices";
const info$4 = { "singularName": "brand-voice", "pluralName": "brand-voices", "displayName": "品牌话术" };
...
const collectionName$3 = "zhao_website_redirect_rules";
const info$3 = { "singularName": "redirect-rule", "pluralName": "redirect-rules", "displayName": "重定向规则" };
...
const attributes$3 = { "site": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-common.site-config", "inversedBy": "website_redirect_rules" }, "fromPath": { "type": "string", "required": true, "maxLength": 500 }, "toUrl": { "type": "string", "required": true, "maxLength": 500 }, "statusCode": { "type": "integer", "default": 301 }, "isActive": { "type": "boolean", "default": true }, "deletedAt": { "type": "datetime", "default": null } };
const redirectRule = {
  kind: kind$3,
...
const collectionName$2 = "zhao_website_invite_traces";
const info$2 = { "singularName": "invite-trace", "pluralName": "invite-traces", "displayName": "邀请码流转埋点" };
...
const collectionName$1 = "zhao_website_geo_articles";
const info$1 = { "singularName": "geo-article", "pluralName": "geo-articles", "displayName": "GEO 文章" };
const options$1 = { "draftAndPublish": false };
const pluginOptions$1 = { "i18n": { "localized": true }, "content-manager": { "visible": true }, "content-type-builder": { "visible": false } };
const attributes$1 = { "site": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-common.site-config", "required": true, "inversedBy": "website_geo_articles" }, "title": { "type": "string", "maxLength": 200, "required": true, "localized": true }, "slug": { "type": "uid", "targetField": "title", "required": true, "localized": true }, "content": { "type": "text", "required": true, "localized": true, "description": "正文（HTML：文字/表格/图片/锚链接/引用标注）" }, "type": { "type": "enumeration", "enum": ["geo-article", "geo-faq", "local-report", "local-comparison", "local-list"], "default": "geo-article", "required": true }, "faqQuestion": { "type": "string", "maxLength": 200, "localized": true, "description": "type=geo-faq 时的问答标题" }, "publishedAt": { "type": "datetime" }, "articleNo": { "type": "string", "maxLength": 32, "unique": true, "description": "唯一数字标签，前端展示" }, "authorName": { "type": "string", "maxLength": 50 }, "authorBio": { "type": "text", "description": "作者从业背景简介（E-E-AT 背书）" }, "status": { "type": "enumeration", "enum": ["draft", "review", "published", "archived"], "default": "draft" }, "category": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-website.article-category" }, "tags": { "type": "relation", "relation": "manyToMany", "target": "plugin::zhao-tag.tag" }, "sourceName": { "type": "string", "maxLength": 100, "description": "权威来源名称" }, "sourceUrl": { "type": "string", "maxLength": 500, "description": "来源 URL（公开信源链接）" }, "sourcePublishedAt": { "type": "datetime", "description": "来源发布时间" }, "serviceScope": { "type": "text", "description": "本地服务范围：服务区县/自提仓库/线下咨询地址/履约时效/配送范围" }, "businessData": { "type": "json", "default": [], "description": "业务数据：[{period, content, caliber}] 统计起止时间/内容/口径" }, "caseContent": { "type": "text", "description": "案例内容（仅客观事实描述，禁止收益承诺）" }, "internalLinks": { "type": "json", "default": [], "description": "内部锚文本：[{text, url}] 配置 1-2 处" }, "metaTitle": { "type": "string", "maxLength": 60, "localized": true }, "metaDescription": { "type": "string", "maxLength": 160, "localized": true, "description": "建议包含吉林本地场景词" }, "canonicalUrl": { "type": "string", "maxLength": 500, "localized": true }, "jsonLdType": { "type": "enumeration", "enum": ["Article", "FAQPage", "LocalBusiness", "ItemList"], "default": "Article" }, "coverImage": { "type": "media" }, "riskType": { "type": "enumeration", "enum": ["none", "finance-general", "finance-stock", "finance-fund", "finance-bond", "finance-wealth", "finance-futures", "finance-precious-metals", "finance-forex", "finance-trust", "finance-convertible-bond", "finance-hk-us-stock", "finance-index", "finance-insurance", "finance-otc", "finance-reverse-repo", "finance-cd", "health", "legal", "other"], "default": "none", "required": true, "description": "风险提示/声明类型（none 不展示；finance-* 为金融细分品类）" }, "riskDisclaimer": { "type": "text", "localized": true, "description": "免责附加文本（默认模板可微调）" }, "ctaType": { "type": "enumeration", "enum": ["none", "download-list", "consult-appointment"], "default": "none", "description": "文末 CTA：本地选购清单下载 / 本地一对一咨询预约 / 不展示" }, "leadFormEnabled": { "type": "boolean", "default": false, "description": "留资表单开关" }, "vendureProductListId": { "type": "string", "maxLength": 50, "description": "关联 Vendure 商品列表 ID，正文内链使用" }, "readPoints": { "type": "integer", "default": 0, "description": "用户阅读/下载提交后发放积分数量" }, "miniProgramPath": { "type": "string", "maxLength": 200, "description": "WebView 场景跳转小程序原生商品页地址" }, "reviewerName": { "type": "string", "maxLength": 50, "description": "验收人" }, "reviewedAt": { "type": "datetime", "description": "验收日期" }, "reviewChecks": { "type": "json", "default": {}, "description": "验收勾选：{eaat, tech, compliance, business} 四类自查" }, "reviewNote": { "type": "text", "description": "上线备注" }, "summaryPoints": { "type": "text", "localized": true, "description": "知识点总结" }, "localTips": { "type": "text", "localized": true, "description": "本地注意事项" }, "infoBoundary": { "type": "text", "localized": true, "description": "信息边界说明（统计范围/适用场景/局限性）" }, "allowIndex": { "type": "boolean", "default": true }, "noFollow": { "type": "boolean", "default": false }, "author": { "type": "relation", "relation": "manyToOne", "target": "plugin::zhao-website.author", "description": "作者档案（可选；缺失时前端回退 authorName/authorBio）" }, "editor": { "type": "relation", "relation": "manyToOne", "target": "admin::user", "description": "编辑人（仅后台记录，不参与前端展示）" }, "reviewer": { "type": "relation", "relation": "manyToOne", "target": "admin::user", "description": "审核人（仅后台记录；前端审核展示用扁平 reviewerName/reviewedAt）" }, "truthBasis": { "type": "relation", "relation": "manyToMany", "target": "plugin::zhao-website.first-truth-policy", "description": "文章背书的真值声明" }, "mentionedEntities": { "type": "relation", "relation": "manyToMany", "target": "plugin::zhao-website.knowledge-entity", "description": "文中提及的知识图谱实体" }, "comparisonData": { "type": "json", "default": [], "description": "type=local-comparison 评分维度：[{dimension, items:[{name, score, note}]}]" }, "listItems": { "type": "json", "default": [], "description": "type=local-list 清单条目：[{name, desc, price, link}]" }, "deletedAt": { "type": "datetime", "default": null } };
const geoArticle$2 = {
  kind: kind$1,
...
const collectionName = "zhao_website_authors";
const info = { "singularName": "author", "pluralName": "authors", "displayName": "文章作者" };
