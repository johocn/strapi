...
const SEOOutputPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(antd.Card, { title: "结构化数据校验", size: "small", style: { marginTop: 16 }, children: /* @__PURE__ */ jsxRuntime.jsxs(antd.Space, { direction: "vertical", children: [
      /* @__PURE__ */ jsxRuntime.jsx(antd.Typography.Text, { children: "使用外部工具校验你的结构化数据：" }),
      /* @__PURE__ */ jsxRuntime.jsx("a", { href: "https://search.google.com/test/rich-results", target: "_blank", rel: "noopener noreferrer", children: "Google Rich Results Test" }),
      /* @__PURE__ */ jsxRuntime.jsx("a", { href: "https://validator.schema.org/", target: "_blank", rel: "noopener noreferrer", children: "Schema.org Validator" })
    ] }) })
  ] });
};
