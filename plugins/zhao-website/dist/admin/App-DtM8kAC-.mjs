...
const SEOOutputPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Card, { title: "结构化数据校验", size: "small", style: { marginTop: 16 }, children: /* @__PURE__ */ jsxs(Space, { direction: "vertical", children: [
      /* @__PURE__ */ jsx(Typography.Text, { children: "使用外部工具校验你的结构化数据：" }),
      /* @__PURE__ */ jsx("a", { href: "https://search.google.com/test/rich-results", target: "_blank", rel: "noopener noreferrer", children: "Google Rich Results Test" }),
      /* @__PURE__ */ jsx("a", { href: "https://validator.schema.org/", target: "_blank", rel: "noopener noreferrer", children: "Schema.org Validator" })
    ] }) })
  ] });
};
const { Option } = Select;
