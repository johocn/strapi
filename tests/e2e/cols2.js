...
const r=await c.query("select table_name,column_name from information_schema.columns where table_name like 'zhao_lesson_progresses_%_lnk' order by table_name");
